...
export interface MonetroTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface MonetroToken extends BaseContract {
  connect(runner?: ContractRunner | null): MonetroToken;
  waitForDeployment(): Promise<this>;

  interface: MonetroTokenInterface;
  ...
  batchMintRewards: TypedContractMethod<
    [recipients: AddressLike[], amounts: BigNumberish[], reasons: string[]],
    [void],
    "nonpayable"
  >;
