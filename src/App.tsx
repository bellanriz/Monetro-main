...
function AppContent() {
  ...
  if (!user) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-950 font-sans p-0 md:p-6 overflow-hidden select-none bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-slate-950 to-black">
        ...
        <div className="w-full h-screen md:max-w-[412px] md:h-[844px] md:rounded-[3.5rem] md:border-[12px] md:border-slate-900 md:shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8)] md:ring-1 md:ring-white/10 md:overflow-hidden relative bg-white flex flex-col justify-between select-text">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 font-sans p-0 md:p-6 overflow-hidden select-none bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-slate-950 to-black">
      ...
      {/* Device Mock Frame (looks like an iPhone on desktop, full bleed on mobile) */}
      <div className="w-full h-screen md:max-w-[412px] md:h-[844px] md:rounded-[3.5rem] md:border-[12px] md:border-slate-900 md:shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8)] md:ring-1 md:ring-white/10 md:overflow-hidden relative bg-slate-50 flex flex-col justify-between select-text">
